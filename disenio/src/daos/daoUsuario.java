...
public class daoUsuario {
    public static Usuario getUsuario(String nickusuario) throws Exception {
        try {
            return ((ArrayList<Usuario>)((Object)Conexion.consultar(("SELECT * FROM Usuario WHERE Nickusuario = '" + nickusuario + "'COLLATE utf8_bin;"), Usuario.class))).get(0);
        }
        catch(Exception ex) {
            throw ex;
        }
    ...
    public static ArrayList<Bedel> obtenerBedel(String nick) throws Exception {
         String consulta = "select * from bedel b where b.nickusuario = '"+nick+"' COLLATE utf8_bin;";
    ...
    public static ArrayList<Admin> obtenerAdmin(String nick)throws Exception{
        String consulta = "select * from Admin a where a.nickusuario = '"+nick+"' COLLATE utf8_bin;";
    ...
    public static ArrayList<ConsultaGenerica> clave(String nick) throws Exception {
        ...
        String consulta1 = "select MAX(c.idclave) AS maxid from clave c where c.nickusuario = '"+nick+"'COLLATE utf8_bin;";
		...
		String consulta = "select  c.claveactual from clave c where  c.idclave='"+Integer.parseInt(res.get(0).getValor("maxid"))+"'COLLATE utf8_bin;";
