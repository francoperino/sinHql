...
class IniciarSesion {
	...
	private void initialize() {
		...
		btnIngresar.setRolloverIcon(new ImageIcon(IniciarSesion.class.getResource("/inicioSesionImgs/button_ingresar2.png")));
		btnIngresar.setBorderPainted(false);
		btnIngresar.setContentAreaFilled(false);
		btnIngresar.setBorder(null);
		btnIngresar.setIcon(new ImageIcon(IniciarSesion.class.getResource("/inicioSesionImgs/button_ingresar.png")));
		...
		btnSalir.setRolloverIcon(new ImageIcon(IniciarSesion.class.getResource("/inicioSesionImgs/button_salir2.png")));
		btnSalir.setBorderPainted(false);
		btnSalir.setContentAreaFilled(false);
		btnSalir.setBorder(null);
		btnSalir.setIcon(new ImageIcon(IniciarSesion.class.getResource("/inicioSesionImgs/button_salir.png")));
		...
		Fondo.setIcon(new ImageIcon(IniciarSesion.class.getResource("/inicioSesionImgs/cambio1.jpg")));
