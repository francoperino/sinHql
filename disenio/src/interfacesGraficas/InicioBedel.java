...
public class InicioBedel extends JFrame {
	...
	public InicioBedel() {
		...
		btnLRDiaEsp.setRolloverIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_dia-especifico (1)2.png")));
		btnLRDiaEsp.setBorderPainted(false);
		btnLRDiaEsp.setContentAreaFilled(false);
		btnLRDiaEsp.setIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_dia-especifico (1).png")));
		btnLRDiaEsp.setBounds(68, 286, 189, 49);
		contentPane.add(btnLRDiaEsp);
		
		JLabel lblKf = new JLabel("Listar Reservas ");
		lblKf.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblKf.setBounds(228, 227, 135, 32);
		contentPane.add(lblKf);
		
		JButton btnBuscarAula = new JButton("");
		btnBuscarAula.setFocusPainted(false);
		btnBuscarAula.setRolloverIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_buscar-aula2.png")));
		btnBuscarAula.setBorderPainted(false);
		btnBuscarAula.setContentAreaFilled(false);
		btnBuscarAula.setIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_buscar-aula.png")));
		...
		btnLRCurso.setRolloverIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_curso2.png")));
		btnLRCurso.setBorderPainted(false);
		btnLRCurso.setContentAreaFilled(false);
		btnLRCurso.setIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_curso.png")));
		...
		btnRegReserva.setRolloverIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_registrar-reserva2.png")));
		btnRegReserva.setBorderPainted(false);
		btnRegReserva.setIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_registrar-reserva.png")));
		...
		btnCerrarSesion.setRolloverIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_cerrar-sesion2.png")));
		btnCerrarSesion.setContentAreaFilled(false);
		btnCerrarSesion.setIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/button_cerrar-sesion.png")));
		...
		txtBedel.setForeground(Color.BLACK);
		txtBedel.setBounds(228, 136, 116, 20);
		contentPane.add(txtBedel);
		txtBedel.setColumns(10);
		
		JLabel Fondo = new JLabel("");
		Fondo.setIcon(new ImageIcon(InicioBedel.class.getResource("/InicioBedelImgs/Captura de pantalla (47).png")));
