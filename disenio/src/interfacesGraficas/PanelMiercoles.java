...
public class PanelMiercoles extends JPanel {
	...
	public PanelMiercoles() {
		...
		button_1.setRolloverIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_lunes2.png")));
		button_1.setIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_lunes.png")));
		...
		button_3.setRolloverIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_miercoles (1)2.png")));
		button_3.setIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_miercoles (1).png")));
