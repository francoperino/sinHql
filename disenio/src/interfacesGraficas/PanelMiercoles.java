...
public class PanelMiercoles extends JPanel {
	...
	public PanelMiercoles() {
		...
		btnLunes.setRolloverIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_lunes2.png")));
		btnLunes.setIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_lunes.png")));
		...
		btnMiercoles.setRolloverIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_miercoles (1)2.png")));
		btnMiercoles.setIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_miercoles (1).png")));
		...
		btnSiguiente.setRolloverIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_siguiente (1)2.png")));
		btnSiguiente.setIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_siguiente (1).png")));
		...
		btnAtras.setRolloverIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_atras (3)2.png")));
		btnAtras.setIcon(new ImageIcon(PanelMiercoles.class.getResource("/imagenes/PanelesRegReserva/button_atras (3).png")));
