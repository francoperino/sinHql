...
public class RegResPeriodica extends JPanel {
	...
	private static Boolean bandera,band;
	private static Integer contadordias,contdiasatras;
	private static boolean btnsig,btnat,cambiardia,bandera7;
	private static Integer contadorGlobalDias;
	private	static ArrayList<ArrayList<String>> selected= new ArrayList<>();
	private static ArrayList<String> l ;
	private static ArrayList<String> m ;
	private static ArrayList<String> mi;
	private static ArrayList<String> j ;
	private static ArrayList<String> v ;
	private static ArrayList<String> s ;
	private static ArrayList<String> aulas;
	private static ArrayList<String> fech ;
	private static ArrayList<String> hi ;
	...
	private static boolean lunesselec,martesselec,miercolesselec,juevesselec,viernesselec,sabadoselec;
	private static Integer contadorseleccion,contadorcheckbox;
	private static boolean cls,cm,cmi,cj,cv,cs;
