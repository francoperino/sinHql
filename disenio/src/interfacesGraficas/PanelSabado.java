...
public class PanelSabado extends JPanel {
	...
	public PanelSabado() {
		...
		btnSiguiente.setRolloverIcon(new ImageIcon(PanelSabado.class.getResource("/imagenes/PanelesRegReserva/button_siguiente (1)2.png")));
		btnSiguiente.setIcon(new ImageIcon(PanelSabado.class.getResource("/imagenes/PanelesRegReserva/button_siguiente (1).png")));
