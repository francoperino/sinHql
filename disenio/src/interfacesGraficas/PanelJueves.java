...
public class PanelJueves extends JPanel {
	...
	public PanelJueves() {
		...
		button_1.setRolloverIcon(new ImageIcon(PanelJueves.class.getResource("/imagenes/PanelesRegReserva/button_lunes2.png")));
		button_1.setIcon(new ImageIcon(PanelJueves.class.getResource("/imagenes/PanelesRegReserva/button_lunes.png")));
		...
		button_4.setRolloverIcon(new ImageIcon(PanelJueves.class.getResource("/imagenes/PanelesRegReserva/button_jueves (1)2.png")));
		button_4.setIcon(new ImageIcon(PanelJueves.class.getResource("/imagenes/PanelesRegReserva/button_jueves (1).png")));
