...
public class PanelMartes extends JPanel {
	...
	public PanelMartes() {
		...
		button_2.setRolloverIcon(new ImageIcon(PanelMartes.class.getResource("/imagenes/PanelesRegReserva/button_martes (1)2.png")));
		button_2.setIcon(new ImageIcon(PanelMartes.class.getResource("/imagenes/PanelesRegReserva/button_martes (1).png")));
