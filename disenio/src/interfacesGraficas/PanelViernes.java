...
public class PanelViernes extends JPanel {
	...
	public PanelViernes() {
		...
		button_1.setRolloverIcon(new ImageIcon(PanelViernes.class.getResource("/imagenes/PanelesRegReserva/button_lunes2.png")));
		button_1.setIcon(new ImageIcon(PanelViernes.class.getResource("/imagenes/PanelesRegReserva/button_lunes.png")));
		...
		button_5.setRolloverIcon(new ImageIcon(PanelViernes.class.getResource("/imagenes/PanelesRegReserva/button_viernes (1)2.png")));
		button_5.setIcon(new ImageIcon(PanelViernes.class.getResource("/imagenes/PanelesRegReserva/button_viernes (1).png")));
